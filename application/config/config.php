...
error_reporting(0); // Disabled to prevent PHP warnings from corrupting AJAX/JSON responses on hosted server
/*
|--------------------------------------------------------------------------
| Base Site URL
|--------------------------------------------------------------------------
...
|
*/
$config['base_url'] = 'http://localhost/krivisha/';

// $config['base_url'] = 'https://fastrankai.in/';

//  $config['base_url'] = 'https://krivishaind.in/';
