                        ...
                        <form method="post" name="add_form" id="add_form" enctype="multipart/form-data">
                            <div class="row flex_wrap">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label>Alankey Bolt<b class="require">*</b></label>
                                    <input id="alankey_bolt" name="alankey_bolt" type="text" class="form-control" value="<?php if (!empty($single)) { echo $single->alankey_bolt;} ?>"
                                           placeholder="Enter alankey bolt" required>
...
<script>
    $(document).ready(function () {
        ...
        $('.alanky_bolt_list').addClass('active_cc');
    });
</script>
<script>
    $(document).ready(function () {
...
<script>
    ...
    $(document).ready(function () {
        $('#add_form').validate({
            ...
            messages: {
                alankey_bolt: {
                    required: "Please enter alankey bolt!",
...
<script>
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_sub_alankey_bolt_list",
                "type": "POST",
            },
            "complete": function () {
