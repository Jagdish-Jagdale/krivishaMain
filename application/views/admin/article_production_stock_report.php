...
<div class="right_col">
    <h3>Article Production Stock Report</h3>
    <div class="main_page">
        ...
        <div class="page_body">
            <div class="page_sec">
                <form method="get" name="maintenance_list" id="maintenance_list" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12 col-sm-6 col-xs-12 mt-3 inline-btns ">
                        ...
                        <a href="<?= base_url() ?>article_production_stock_report" class="btn btn-sm btn-danger"
            ...
            <div class="x_panel">
                <table style="width: 100%;" class="table table-striped table-bordered" id="article_list">
                    <thead class="thead">
                        <tr>
                            <th>SR. NO.</th>
                            <th>Date & Time</th>
...
$(document).ready(function() {
    ...
    $('.article_production_stock_report').addClass('active_cc');
});
</script>
...
$(document).ready(function() {
    ...
    var table = $('#article_list').DataTable({
        ...
        "ajax": {
            "url": "<?= base_url() ?>admin/Ajax_controller/get_all_article_report_list",
            "type": "POST",
            "data": function(data) {
