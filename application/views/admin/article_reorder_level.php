                ...
                <form method="get" name="maintenance_list" id="maintenance_list" enctype="multipart/form-data">
                    <div class="row flex_wrap">
                        ...
                        <div class="form-group col-xl-3 col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <select class="form-control js-example-basic" name="article" id="article">
                    ...
                    <div class="form-group col-md-12 col-sm-6 col-xs-12 mt-3 inline-btns ">
                        ...
                        <a href="<?= base_url() ?>article_reorder_level" class="btn btn-sm btn-danger" id="reset_btn">Reset</a>
                    </div>
                    </div>
                </form>
            </div>
...
<script>
    $(document).ready(function () {
        $('#alticle_reorder_level').addClass('nv active-color');
        var table = $('#example').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    title: 'Article Re-order List',
                    footer: true,
                    filename: 'article_reorder_list',
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4]
                    }
                }
