                        ...
                        <form method="post" name="add_machine_form" id="add_machine_form" enctype="multipart/form-data">
                            <div class="row flex_wrap">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label>Brand Type<b class="require">*</b></label>
                                    <input id="brand_type" name="brand_type" type="text" class="form-control" value="<?php if (!empty($single)) { echo $single->brand_type;} ?>"
                                           placeholder="Enter brand type" required>
...
<script>
    $(document).ready(function () {
        ...
        $('.brand_type_list').addClass('active_cc');
    });
</script>
<script>
    $(document).ready(function () {
...
<script>
    ...
    $(document).ready(function () {
        $('#add_machine_form').validate({
            ...
            messages: {
                brand_type: {
                    required: "Please enter brand type!",
...
<script>
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_sub_brand_type_list",
                "type": "POST",
            },
            "complete": function () {
