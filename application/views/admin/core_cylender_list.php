        ...
        <div class="col-md-4">
            <div class="page-title">
                <div class="title_left">
                    <h3>Core Cylinder Seal Spring</h3>
                </div>
            </div>
                        ...
                        <form method="post" name="add_form" id="add_form" enctype="multipart/form-data">
                            <div class="row flex_wrap">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label>Core Cylinder Seal<b class="require">*</b></label>
                                    <input id="core_cylinder_seal" name="core_cylinder_seal" type="text" class="form-control" value="<?php if (!empty($single)) { echo $single->core_cylinder_seal;} ?>"
                                           placeholder="Enter core cylender seal" required>
...
<script>
    $(document).ready(function () {
        ...
        $('.core_cylender_list').addClass('active_cc');
    });
</script>
<script>
    $(document).ready(function () {
...
<script>
    ...
    $(document).ready(function () {
        $('#add_form').validate({
            ...
            messages: {
                core_cylinder_seal: {
                    required: "Please enter core cylinder seal!",
...
<script>
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    footer: true,
                    title: 'Core Cylinder Seal',
                    filename: 'core_cylender_list',
                    exportOptions: {
                        columns: [0, 1]
                    }
                }
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_sub_core_cylender_list",
                "type": "POST",
            },
            "complete": function () {
