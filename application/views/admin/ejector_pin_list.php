                        ...
                        <form method="post" name="add_form" id="add_form" enctype="multipart/form-data">
                            <div class="row flex_wrap">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label>Ejector Pin<b class="require">*</b></label>
                                    <input id="ejector_pin" name="ejector_pin" type="text" class="form-control" value="<?php if (!empty($single)) { echo $single->ejector_pin;} ?>"
                                           placeholder="Enter ejector pin" required>
...
<script>
    $(document).ready(function () {
        ...
        $('.ejector_pin_list').addClass('active_cc');
    });
</script>
<script>
    $(document).ready(function () {
...
<script>
    ...
    $(document).ready(function () {
        $('#add_form').validate({
            ...
            messages: {
                ejector_pin: {
                    required: "Please enter ejector pin!",
...
<script>
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    footer: true,
                    title: 'Ejector Pin List',
                    filename: 'ejector_pin_list',
                    exportOptions: {
                        columns: [0, 1]
                    }
                }
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_sub_ejector_pin_list",
                "type": "POST",
            },
            "complete": function () {
