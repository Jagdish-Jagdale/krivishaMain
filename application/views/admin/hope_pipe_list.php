                        ...
                        <form method="post" name="add_form" id="add_form" enctype="multipart/form-data">
                            <div class="row flex_wrap">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label>Hose Pipe<b class="require">*</b></label>
                                    <input id="hose_pipe" name="hose_pipe" type="text" class="form-control" value="<?php if (!empty($single)) { echo $single->hose_pipe;} ?>"
                                           placeholder="Enter hose pipe" required>
...
<script>
    $(document).ready(function () {
        ...
        $('.hope_pipe_list').addClass('active_cc');
    });
</script>
<script>
    $(document).ready(function () {
...
<script>
    ...
    $(document).ready(function () {
        $('#add_form').validate({
            ...
            messages: {
                hose_pipe: {
                    required: "Please enter hose pipe!",
...
<script>
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    footer: true,
                    title: 'Hose Pipe List',
                    filename: 'hope_pipe_list',
                    exportOptions: {
                        columns: [0, 1]
                    }
                }
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_sub_hose_pipe_list",
                "type": "POST",
            },
            "complete": function () {
