                        ...
                        <div class="row flex_wrap">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <input name="gate_entry_date" type="date" id="gate_entry_date" class="form-control datepicker" 
        ...
        $('#material_id').on('change', function () {
            ...
            if (!materialExists && materialId) {
                $.ajax({
                    ...
                    <td>
                        <input type="number" min="1" class="form-control" name="quantity[]" placeholder="Enter quantity" required>
                    </td>
                    <td>
