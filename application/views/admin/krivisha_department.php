...
<div class="right_col" role="main">
    ...
    <div class="row">
                        ...
                        <form method="post" name="add_uom_form" id="add_uom_form" enctype="multipart/form-data">
                            <div class="row flex_wrap">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label>Department Name<b class="require">*</b></label>
                                    <input id="department" name="department" type="text" class="form-control" value="<?php if (!empty($single)) {
        ...
        <div class="col-md-8">
            <div class="page-title">
                <div class="title_left">
                    <h3>Krivisha Department List</h3>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        $('.krivisha_department').addClass('active_cc');
...
<script>
    ...
    function checkDepartmentUnique() {
        ...
        $.ajax({
            url: '<?= base_url() ?>admin/Ajax_controller/check_unique_department_name',
            method: 'post',
            data: {
                'department': name,
                'id': id
            ...
            success: function (response) {
                if (response == '1') {
                    $('#name_error').text("This department already exists!");
...
<script>
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_all_krivisha_department_list",
                "type": "POST",
            },
            "complete": function () {
