    ...
    <div class="table">
        <div class="page-title">
            <div class="title_left">
                <h3>Material Requistition List</h3>
            </div>
        </div>
                ...
                <form method="get" name="maintenance_list" id="maintenance_list" enctype="multipart/form-data">
                    <div class="row flex_wrap">
                        ...
                        <div class="form-group col-md-12 col-sm-6 col-xs-12 mt-3 inline-btns ">
                            ...
                            <a href="<?= base_url() ?>material_artical_requistition_from_list" class="btn btn-sm btn-danger" id="reset_btn">Reset</a>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
        ...
        $('.material_artical_requistition_from_list').addClass('active_cc');
...
<script>
    $(document).ready(function() {
        var table = $('#example').DataTable({
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_all_material_qty_request_list",
                "type": "POST",
                "data": function(data) {
