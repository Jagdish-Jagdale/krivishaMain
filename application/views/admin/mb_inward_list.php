    ...
    <div class="table">
        <div class="page-title">
            <div class="title_left">
                <h3>Master Batch Inward List</h3>
            </div>
        </div>
                ...
                <form method="get" name="maintenance_list" id="maintenance_list" enctype="multipart/form-data">
                    <div class="row flex_wrap">
                        ...
                        <div class="form-group col-md-12 col-sm-6 col-xs-12 mt-3 inline-btns ">
                            ...
                            <a href="<?= base_url() ?>mb_inward_list" class="btn btn-sm btn-danger" id="reset_btn">Reset</a>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
        ...
        $('.mb_inward_list').addClass('active_cc');
        ...
        var table = $('#example').DataTable({
            ...
            "ajax": {
                ...
                "data": function(data) {
                    ...
                    data.inward_for = '1'; //for Master batch inward
                },
            },
