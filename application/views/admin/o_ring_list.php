                        ...
                        <form method="post" name="add_form" id="add_form" enctype="multipart/form-data">
                            <div class="row flex_wrap">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label>O Ring<b class="require">*</b></label>
                                    <input id="o_ring" name="o_ring" type="text" class="form-control" value="<?php if (!empty($single)) { echo $single->o_ring;} ?>"
                                           placeholder="Enter o ring" required>
...
<script>
    $(document).ready(function () {
        ...
        $('.o_ring_list').addClass('active_cc');
    });
</script>
<script>
    $(document).ready(function () {
...
<script>
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_sub_o_ring_list",
                "type": "POST",
            },
            "complete": function () {
