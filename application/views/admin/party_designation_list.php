                        ...
                        <form method="post" name="add_machine_form" id="add_machine_form" enctype="multipart/form-data">
                            <div class="row flex_wrap">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input id="designation" name="designation" type="text" class="form-control" value="<?php if (!empty($single)) { echo $single->designation;} ?>"
...
<script>
    $(document).ready(function () {
        ...
        $('.party_designation_list').addClass('active_cc');
    });
</script>
<script>
    $(document).ready(function () {
...
<script>
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_sub_party_designation_list",
                "type": "POST",
            },
            "complete": function () {
