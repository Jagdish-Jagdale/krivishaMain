    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="x_panel">
                <div class="x_content">
                    <div class="container">
                        <form method="post" name="add_machine_form" id="add_form" enctype="multipart/form-data">
                            <div class="row flex_wrap">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label>Type of Business<b class="require">*</b></label>
                                    <input id="type_of_business" name="type_of_business" type="text" class="form-control" value="<?php if (!empty($single)) { echo $single->type_of_business;} ?>"
                                           placeholder="Enter type of business" required>
...
<script>
    $(document).ready(function () {
        ...
        $('.party_type_businesss_list').addClass('active_cc');
    });
</script>
<script>
    $(document).ready(function () {
...
<script>
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    footer: true,
                    title: 'Type of Business List',
                    filename: 'type_of_business_list',
                    exportOptions: {
                        columns: [0, 1]
                    }
                }
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_sub_party_type_list",
                "type": "POST",
            },
            "complete": function () {
