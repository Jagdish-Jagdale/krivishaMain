...
<?php
if (!isset($check_readonly)) {
    $profile = $this->Admin_model->get_user_profile();
    $is_superadmin = (isset($profile->is_admin) && $profile->is_admin == '1');
    $is_plant_manager = (isset($profile->designation) && strtoupper(trim($profile->designation)) === 'PLANT MANAGER');

    $check_readonly = function($value, $pm_status) use ($is_superadmin, $is_plant_manager) {
        if ($is_superadmin) {
            return '';
        }
        
        $has_data = (isset($value) && $value !== '');
        $pm_submitted = (isset($pm_status) && in_array((string)$pm_status, ['0', '1'], true));

        if ($is_plant_manager) {
            return $pm_submitted ? 'readonly' : '';
        }
        
        // Operator
        return $has_data ? 'readonly' : '';
    };
}
?>
...
<div class="right_col" role="main">
    ...
    <div class="table1">
        ...
        <div class="row">
            <div class="x_panel">
                <div class="x_content">
                    <form method="post" name="production_form_list" id="production_form_list_for_article_from"
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="qty_eight_nine_<?= $article->id ?>"
                                                        id="qty_eight_nine_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_eight_nine) ? $article_production_data->qty_eight_nine : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_nine_ten_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_nine_ten) ? $article_production_data->qty_nine_ten : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                ...
                                                <td><input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_ten_eleven_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_ten_eleven) ? $article_production_data->qty_ten_eleven : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                ...
                                                <td><input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_eleven_twelve_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_eleven_twelve) ? $article_production_data->qty_eleven_twelve : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                ...
                                                <td><input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_twelve_thirteen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_twelve_thirteen) ? $article_production_data->qty_twelve_thirteen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                    <input type="hidden"
                                                ...
                                                <td><input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_thirteen_fourteen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_thirteen_fourteen) ? $article_production_data->qty_thirteen_fourteen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                    <input type="hidden"
                                                ...
                                                <td><input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_fourteen_fifteen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_fourteen_fifteen) ? $article_production_data->qty_fourteen_fifteen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                    <input type="hidden"
                                                ...
                                                <td><input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_fifteen_sixteen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_fifteen_sixteen) ? $article_production_data->qty_fifteen_sixteen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                    <input type="hidden"
                                                ...
                                                <td><input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_sixteen_seventeen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_sixteen_seventeen) ? $article_production_data->qty_sixteen_seventeen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                    <input type="hidden"
                                                ...
                                                <td><input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_seventeen_eighteen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_seventeen_eighteen) ? $article_production_data->qty_seventeen_eighteen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                    <input type="hidden"
                                                ...
                                                <td><input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_eighteen_nineteen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_eighteen_nineteen) ? $article_production_data->qty_eighteen_nineteen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)" type="text"
                                                        ...
                                                        id="qty_nineteen_twenty_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_nineteen_twenty) ? $article_production_data->qty_nineteen_twenty : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_twenty_twentyone_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_twenty_twentyone) ? $article_production_data->qty_twenty_twentyone : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_twentyone_twentytwo_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_twentyone_twentytwo) ? $article_production_data->qty_twentyone_twentytwo : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_twentytwo_twentythree_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_twentytwo_twentythree) ? $article_production_data->qty_twentytwo_twentythree : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_twentythree_zero_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_twentythree_zero) ? $article_production_data->qty_twentythree_zero : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_zero_one_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_zero_one) ? $article_production_data->qty_zero_one : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_one_two_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_one_two) ? $article_production_data->qty_one_two : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_two_three_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_two_three) ? $article_production_data->qty_two_three : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_three_four_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_three_four) ? $article_production_data->qty_three_four : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_four_five_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_four_five) ? $article_production_data->qty_four_five : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_five_six_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_five_six) ? $article_production_data->qty_five_six : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_six_seven_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_six_seven) ? $article_production_data->qty_six_seven : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); check_input(this)"
                                                        ...
                                                        id="qty_seven_eight_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->qty_seven_eight) ? $article_production_data->qty_seven_eight : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>
                                                ...
                                                <td rowspan="2">
                                                    <textarea name="remark_<?= $article->id ?>"
                                                        ...
                                                        class="form-control"><?= isset($article_production_data->remark) ? $article_production_data->remark : '' ?></textarea>
                                            ...
                                            <tr>
                                                ...
                                                <td><input onkeyup="updateTotals(this);"
                                                        ...
                                                        id="weight_eight_nine_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_eight_nine) ? $article_production_data->weight_eight_nine : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                ...
                                                <td><input onkeyup="updateTotals(this);"
                                                        ...
                                                        id="weight_nine_ten_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_nine_ten) ? $article_production_data->weight_nine_ten : null, isset($article_production_data->status) ? $article_production_data->status : null) ?>>
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_ten_eleven_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_ten_eleven) ? $article_production_data->weight_ten_eleven : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_eleven_twelve_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_eleven_twelve) ? $article_production_data->weight_eleven_twelve : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_twelve_thirteen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_twelve_thirteen) ? $article_production_data->weight_twelve_thirteen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_thirteen_fourteen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_thirteen_fourteen) ? $article_production_data->weight_thirteen_fourteen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_fourteen_fifteen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_fourteen_fifteen) ? $article_production_data->weight_fourteen_fifteen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); " type="text"
                                                        ...
                                                        id="weight_fifteen_sixteen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_fifteen_sixteen) ? $article_production_data->weight_fifteen_sixteen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); " type="text"
                                                        ...
                                                        id="weight_sixteen_seventeen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_sixteen_seventeen) ? $article_production_data->weight_sixteen_seventeen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); " type="text"
                                                        ...
                                                        id="weight_seventeen_eighteen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_seventeen_eighteen) ? $article_production_data->weight_seventeen_eighteen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_eighteen_nineteen_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_eighteen_nineteen) ? $article_production_data->weight_eighteen_nineteen : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_nineteen_twenty_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_nineteen_twenty) ? $article_production_data->weight_nineteen_twenty : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_twenty_twentyone_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_twenty_twentyone) ? $article_production_data->weight_twenty_twentyone : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_twentyone_twentytwo_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_twentyone_twentytwo) ? $article_production_data->weight_twentyone_twentytwo : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_twentytwo_twentythree_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_twentytwo_twentythree) ? $article_production_data->weight_twentytwo_twentythree : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_twentythree_zero_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_twentythree_zero) ? $article_production_data->weight_twentythree_zero : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_zero_one_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_zero_one) ? $article_production_data->weight_zero_one : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_one_two_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_one_two) ? $article_production_data->weight_one_two : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_two_three_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_two_three) ? $article_production_data->weight_two_three : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_three_four_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_three_four) ? $article_production_data->weight_three_four : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_four_five_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_four_five) ? $article_production_data->weight_four_five : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_five_six_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_five_six) ? $article_production_data->weight_five_six : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this);" type="text"
                                                        ...
                                                        id="weight_six_seven_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_six_seven) ? $article_production_data->weight_six_seven : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                ...
                                                <td>
                                                    <input onkeyup="updateTotals(this); " type="text"
                                                        ...
                                                        id="weight_seven_eight_<?= $article->id ?>" <?= $check_readonly(isset($article_production_data->weight_seven_eight) ? $article_production_data->weight_seven_eight : null, isset($article_production_data->status) ? $article_production_data->status : null) ?> />
                                                    <input type="hidden"
    ...
    <div class="table1">
        ...
        <div class="row">
            <div class="x_panel">
                <div class="x_content">
                    <form method="post" name="production_form_list" id="production_form_list_raw_material"
                        class="production_form_list" enctype="multipart/form-data">
                        <div class="container overflow_x">
                            <table style="width: 100%;" class="table table-striped table-bordered" id="data8-9able">
                                ...
                                <input type="hidden" name="machine_id" id="machine_id_for_raw_material"
                                    value="<?= $machine->machine_id ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <textarea name="remark"
                                                        ...
                                                        class="form-control"><?= isset($raw_material_production_data->remark) ? $raw_material_production_data->remark : '' ?></textarea>
    ...
    <div class="table1">
        ...
        <div class="row">
            <div class="x_panel">
                <div class="x_content">
                    <form method="post" name="production_form_list" id="production_form_list_for_master_batch"
                        class="production_form_list" enctype="multipart/form-data">
                        <div class="container overflow_x">
                            <table style="width: 100%;" class="table table-striped table-bordered" id="data8-9able">
                                <thead class="thead">
                                ...
                                <!-- <input type="hidden" id="production_id" name="production_id"
                                    value="<?= $prodution_id ?>"> -->
                                <input type="hidden" name="machine_id" id="machine_id_for_master_batch"
                                    value="<?= $machine->machine_id ?>">
                                <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <textarea name="remark"
                                                        ...
                                                        class="form-control"><?= isset($master_batch_production_data->remark) ? $master_batch_production_data->remark : '' ?></textarea>
                                                ...
                                                <td class="inline-btns">
                                                    ...
                                                    <button class="btn btn-secondary table_btn" data-bs-toggle="modal" data-bs-target="#exampleModal2" name="check_logs_mb" id="check_logs_mb">Log</button>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endforeach; ?>
    ...
    <div class="table1">
        ...
        <div class="row">
            <div class="x_panel">
                <div class="x_content">
                    <form method="post" name="production_form_list" id="production_form_list_for_rejection"
                        class="production_form_list" enctype="multipart/form-data">
                        <div class="container overflow_x">
                            <table style="width: 100%;" class="table table-striped table-bordered" id="data8-9able">
                                <thead class="thead">
                                ...
                                <input type="hidden" name="machine_id" id="machine_id_for_rejection"
                                    value="<?= $machine->machine_id ?>">
                                <tbody>
                                    <?php foreach ($rejection_data as $rejection): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea name="remark" id="remark___<?= $rejection->id ?>"
                                                    class="form-control"><?= isset($rejection_production_data->remark) ? $rejection_production_data->remark : '' ?></textarea>
                                            </td>
    ...
    <div class="table1">
        ...
        <div class="row">
            <div class="x_panel">
                <div class="x_content">
                    <form method="post" name="production_form_list" id="production_form_list_balance_quantity"
                        class="production_form_list" enctype="multipart/form-data">
                        <div class="container overflow_x">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (!empty($raw_material) || !empty($master_batch)): ?>
                                                    ...
                                                    <textarea name="remark"
                                                        id="remark_<?= !empty($master_batch->id) ? $master_batch->id : 'null' ?>_<?= !empty($raw_material->id) ? $raw_material->id : 'null' ?>"
                                                        class="form-control"><?= isset($balance_data->remark) ? $balance_data->remark : '' ?></textarea>
    ...
    <div class="table1">
        ...
        <div class="row">
            <div class="x_panel">
                <div class="x_content">
                    <form method="post" name="production_form_list" id="production_form_list_for_summary"
                        class="production_form_list" enctype="multipart/form-data">
                        <div class="container overflow_x">
                            <table style="width: 100%;" class="table table-striped table-bordered" id="data8-9able">
                                <thead class="thead">
                                ...
                                <tbody>
                                    ...
                                    foreach ($article_data as $article) {
                                        ...
                                        $summary_data = $this->Admin_model->get_production_summary($this->uri->segment(2), $article->id);
                                        ...
                                        <tr data-article-id="<?= $article->id ?>">
                                            ...
                                            <td>
                                                ...
                                                <textarea name="remark_<?= $article->id ?>" id="remark_<?= $article->id ?>"
                                                    class="form-control"><?= isset($summary_data->remark) ? strip_tags($summary_data->remark) : '' ?></textarea>
                                            </td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <select id="remark" class="form-control">
                    ...
                    <?php if (!empty($remark_master_list)) {
                        foreach ($remark_master_list as $remark_option) { ?>
                            <option value="<?= htmlspecialchars($remark_option->remark_name) ?>">
                                <?= htmlspecialchars($remark_option->remark_name) ?>
                            </option>
                        <?php }
                    } ?>
                </select>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (json.status === "success" && json.data.length) {
                    ...
                    const prodImgBase = baseUrl + "assets/images/production/";

                    const galleryHtml = json.data.map(img => {
                        // Android images are stored as full relative path e.g. "assets/images/production/prod_1_xxx.jpg"
                        // Web images are stored as bare filename e.g. "abc123.jpg"
                        let src;
                        if (img.image_names && img.image_names.indexOf('/') !== -1) {
                            // Full path stored — just prepend base_url
                            src = baseUrl + img.image_names.replace(/^\/+/, '');
                        } else {
                            // Bare filename — prepend production folder
                            src = prodImgBase + img.image_names;
                        }
...
<script>
    ...
    $('#add_remark').on('shown.bs.modal', function () {
        ...
        const $remarkSelect = $modal.find('#remark');

        // initialize
        $remarkSelect.removeClass('is-invalid');
        const hasSelection = ($remarkSelect.val() || '').trim().length > 0;
        $saveBtn.prop('disabled', !hasSelection);

        $remarkSelect.off('change').on('change', () => {
            const hasSelection = ($remarkSelect.val() || '').trim().length > 0;
            $remarkSelect.toggleClass('is-invalid', !hasSelection);
            $saveBtn.prop('disabled', !hasSelection);
        });

        $saveBtn.off('click').on('click', () => {
            const remark = ($remarkSelect.val() || '').trim();
            if (!remark) {
                $remarkSelect.addClass('is-invalid').focus();
                return;
            }
    ...
    $(function () {
        $('[id^="qty_"]').on('click focus', function () {
            remark_popup(this, true);
        });
    ...
    $(document).ready(function () {
        ...
        var validator = $("#production_form_list_for_article_from").validate({
    ...
    function set_article_production_details(id) {
        let formData = {
            ...
            day_shift_op1: $('#day_shift_op1_' + id).val(),
            day_shift_op2: $('#day_shift_op2_' + id).val(),
            night_shift_op1: $('#night_shift_op1_' + id).val(),
            night_shift_op2: $('#night_shift_op2_' + id).val(),
            qty_data: {},
            weight_data: {}
        };
    ...
    function set_raw_material_production_details(raw_material_id, article_id) {
        let formData = {
            production_id: $('#production_id').val(),
            machine_id: $('#machine_id_for_raw_material').val(),
    ...
    function set_master_batch_production_details(master_batch_id, article_id) {
        let formData = {
            production_id: $('#production_id').val(),
            machine_id: $('#machine_id_for_master_batch').val(),
    ...
    function set_rejection_production_details(rejection_id) {
        let formData = {
            production_id: $('#production_id').val(),
            machine_id: $('#machine_id_for_rejection').val(),
            rejection_id: rejection_id,
            total_qty: $('#total_qty___' + rejection_id).val(),
            pc: $('#pc___' + rejection_id).val(),
            runner_gms: $('#runner_gms___' + rejection_id).val(),
            flash_gm: $('#flash_gm___' + rejection_id).val(),
            lumps_gm: $('#lumps_gm___' + rejection_id).val(),
            plant_manager_approval_status: $('#plant_manager_approval_status___' + rejection_id).val(),
            remark: $('#remark___' + rejection_id).val()
        };
        $.ajax({
            ...
            if (xhr.status === 200) {
                try {
                    ...
                    if (response.status === 'success') {
                        ...
                        errorEl.innerText = response.message || 'Error uploading images.';
                    }
                } catch (e) {
                    errorEl.innerText = 'Invalid upload response.';
                }
            } else {
            ...
            success: function (response) {
              ...
              <tr>
                ...
                ${[
                                ...
                                return `<td style="${isEmpty ? 'color:#aaa;font-style:italic;' : ''}">${isEmpty ? 'No entries' : v}</td>`;
                            }).join('')}
...
<script>
    $(document).ready(function () {
        ...
        var validator = $("#production_form_list_for_rejection").validate({
    ...
    $(document).ready(function () {
        ...
        if (typeof set_rejection_production_details === 'function') {
            ...
            window.set_rejection_production_details = function (rejectionId) {
                let dropdownId = "plant_manager_approval_status___" + rejectionId;
                let fields = ["total_qty___", "pc___", "runner_gms___", "flash_gm___", "lumps_gm___"];
...
<script>
    $(document).ready(function () {
        // Only lock fields in a row if the Plant Manager Approval Status is 'Approve' (0)
        $('.table1 select.status-select').each(function () {
            var $this = $(this);
            var val = $this.val();
            ...
            if (val === '0') {
                ...
                $tr.find('input[type="text"], textarea').prop('readonly', true);
                
                // Disable the status select dropdown itself
                $this.prop('disabled', true);
                
                // Disable the Save button
                $tr.find('button.btn-primary, button.hourly-submit').prop('disabled', true);
                
                // For the Production Report table, the weight inputs are on the next row
                var $nextTr = $tr.next('tr');
                if ($nextTr.length > 0 && $nextTr.find('td:first').text().trim() === 'Weight Per Hour') {
                    $nextTr.find('input[type="text"], textarea').prop('readonly', true);
                    $nextTr.find('button.btn-primary, button.hourly-submit').prop('disabled', true);
                }
            }
        });

        // Set placeholder for empty entry fields
        $('#dataTable input[type="text"]').attr('placeholder', 'No scheduled');
    });
</script>