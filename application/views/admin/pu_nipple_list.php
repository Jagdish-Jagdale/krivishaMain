                        ...
                        <form method="post" name="add_form" id="add_form" enctype="multipart/form-data">
                            <div class="row flex_wrap">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label>PU Nipples<b class="require">*</b></label>
                                    <input id="pu_nipples" name="pu_nipples" type="text" class="form-control" value="<?php if (!empty($single)) { echo $single->pu_nipples;} ?>"
                                           placeholder="Enter pu nipples" required>
...
<script>
    $(document).ready(function () {
        ...
        $('.pu_nipple_list').addClass('active_cc');
    });
</script>
<script>
    $(document).ready(function () {
...
<script>
    ...
    $(document).ready(function () {
        $('#add_form').validate({
            ...
            messages: {
                pu_nipples: {
                    required: "Please enter pu nipples!",
...
<script>
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    footer: true,
                    title: 'PU Nipples List',
                    filename: 'pu_nipple_list',
                    exportOptions: {
                        columns: [0, 1]
                    }
                }
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_sub_pu_nipples_list",
                "type": "POST",
            },
            "complete": function () {
