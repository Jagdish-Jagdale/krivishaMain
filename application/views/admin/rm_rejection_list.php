    ...
    <div class="table">
        <div class="page-title">
            <div class="title_left">
                <h3>Raw Material Rejection List</h3>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.rm_rejection_list').addClass('active_cc');
...
<script>
    $(document).ready(function() {
        ...
        scrollCollapse: true,
        "ajax": {
            "url": "<?=base_url()?>admin/Ajax_controller/get_all_rm_rejection_list",
            "type": "POST",
        },
        "complete": function() {
