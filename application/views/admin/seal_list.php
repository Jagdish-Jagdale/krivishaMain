                        ...
                        <form method="post" name="add_form" id="add_form" enctype="multipart/form-data">
                            <div class="row flex_wrap">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label>Seal<b class="require">*</b></label>
                                    <input id="seal" name="seal" type="text" class="form-control" value="<?php if (!empty($single)) { echo $single->seal;} ?>"
                                           placeholder="Enter seal" required>
...
<script>
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_sub_seal_list",
                "type": "POST",
            },
            "complete": function () {
