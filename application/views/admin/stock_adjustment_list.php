                ...
                <form method="get" name="maintenance_list" id="maintenance_list" enctype="multipart/form-data">
                    <div class="row flex_wrap">
                        ...
                        <div class="form-group col-md-12 col-sm-6 col-xs-12 mt-3 inline-btns ">
                            ...
                            <a href="<?= base_url() ?>stock_adjustment_list" class="btn btn-sm btn-danger"
...
<script>
        ...
        $('.stock_adjustment_list').addClass('active_cc');
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#mb_list').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_mb_stock_adjustment_list",
                "type": "POST",
                "data": function(data) {
                    data.search_date = $('#search_date').val();
                    data.plant_id = $('#search_plant_id').val();
        ...
        var table = $('#article_list').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_article_stock_adjustment_list",
                "type": "POST",
                "data": function(data) {
                    data.search_date = $('#search_date').val();
                    data.plant_id = $('#search_plant_id').val();
                    data.article_id = $('#article_id').val();
                    data.stock_adjusted_for = '3';
                },
            },
            "drawCallback": function(settings) {
                $('[data-toggle="tooltip"]').tooltip();
