...
<div class="right_col">
    <h3>Stock Transfer Report(One Plant To Other Plant)</h3>
    <div class="main_page">
        ...
        <div class="page_body">
            <div class="page_sec">
                <form method="get" name="maintenance_list" id="maintenance_list" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12 col-sm-6 col-xs-12 mt-3 inline-btns ">
                        ...
                        <a href="<?= base_url() ?>stock_report_raw_material" class="btn btn-sm btn-danger"
            ...
            <h2 class="article_group">Article (Mould) Report</h2>
...
$(document).ready(function() {
    ...
    $('.stock_report_raw_material').addClass('active_cc');
});
</script>
...
$(document).ready(function() {
    var table = $('#example').DataTable({
        ...
        "ajax": {
            "url": "<?= base_url() ?>admin/Ajax_controller/get_all_raw_material_report_list",
            "type": "POST",
            "data": function(data) {
    ...
    var table = $('#mb_list').DataTable({
        ...
        buttons: [{
            ...
            filename: 'stock_adjustment_list',
            exportOptions: {
        ...
        "ajax": {
            "url": "<?= base_url() ?>admin/Ajax_controller/get_mb_stock_report_one_plant_to_other_list",
            "type": "POST",
            "data": function(data) {
                data.search_date = $('#search_date').val();
                data.plant_id = $('#search_plant_id').val();
                data.master_batch_id = $('#master_batch_id').val();
                data.stock_adjusted_for = '2';
            },
        },
    ...
    var table = $('#article_list').DataTable({
        ...
        "ajax": {
            "url": "<?= base_url() ?>admin/Ajax_controller/get_all_article_report_one_plant_to_other_list",
            "type": "POST",
            "data": function(data) {
                data.search_date = $('#search_date').val();
                data.plant_id = $('#search_plant_id').val();
