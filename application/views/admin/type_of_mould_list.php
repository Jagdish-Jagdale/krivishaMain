                        ...
                        <form method="post" name="add_form" id="add_form" enctype="multipart/form-data">
                            <div class="row flex_wrap">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label>Type of Mould<b class="require">*</b></label>
                                    <input id="type_of_mould" name="type_of_mould" type="text" class="form-control" value="<?php if (!empty($single)) { echo $single->type_of_mould;} ?>"
                                           placeholder="Enter type of mould" required>
...
<script>
    $(document).ready(function () {
        ...
        $('.type_of_mould_list').addClass('active_cc');
    });
</script>
<script>
    $(document).ready(function () {
...
<script>
    ...
    $(document).ready(function () {
        $('#add_form').validate({
            ...
            messages: {
                type_of_mould: {
                    required: "Please enter type of mould!",
...
<script>
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    footer: true,
                    title: 'Type of Mould List',
                    filename: 'type_of_mould_list',
                    exportOptions: {
                        columns: [0, 1]
                    }
                }
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_sub_type_of_mould_list",
                "type": "POST",
            },
            "complete": function () {
