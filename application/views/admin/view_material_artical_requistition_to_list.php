    ...
    <div class="table">
        <div class="page-title">
            <div class="title_left">
                <h3>View Details/Material Transfer</h3>
            </div>
        </div>
                    ...
                    <div class="container">
                        <form method="post" name="add_material" id="add_material" enctype="multipart/form-data">
                            <table style="width: 100%;" class="table table-striped table-bordered" id="example">
                                ...
                                <tbody>
                                    <?php if (!empty($material_requistion_list)): ?>
                                        <?php $srNo = 1; ?>
                                        <?php foreach ($material_requistion_list as $item):
                                            ...
                                            <tr>
                                                <td><?= $srNo++; ?></td>
                                                <td><?= $item->rm_name; ?></td>
                                                <td><?= !empty($item->uom_name) ? $item->uom_name : 'N/A'; ?>
                                                </td>
                                                <td><?= $item->request_quantity; ?></td>
                                                <td>
                                                    <input type="hidden" name="plant_id" value="<?= $item->plant_id ?>">

                                                    <input type="hidden" name="raw_material_id[<?= $srNo ?>]" value="<?= $item->raw_material_id ?>">
                                                    <input type="hidden" name="uom_id[<?= $srNo ?>]" value="<?= $item->uom_id ?>">
