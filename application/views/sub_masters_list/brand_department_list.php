                        ...
                        <form method="post" name="add_machine_form" id="add_machine_form" enctype="multipart/form-data">
                            <div class="row flex_wrap">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input id="department" name="department" type="text" class="form-control" value="<?php if (!empty($single)) { echo $single->department;} ?>"
...
<script>
    $(document).ready(function () {
        ...
        $('.brand_department_list').addClass('active_cc');
    });
</script>
<script>
    $(document).ready(function () {
...
<script>
    ...
    $(document).ready(function () {
        $('#add_machine_form').validate({
            ...
            messages: {
                department: {
                    required: "Please enter department type!",
...
<script>
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            scrollCollapse: true,
            "ajax": {
                "url": "<?= base_url() ?>admin/Ajax_controller/get_sub_department_list",
                "type": "POST",
            },
            "complete": function () {
